  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", color: "#0f172a" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
        <div>
          <h1 style={{ fontSize: 25, fontWeight: 700, margin: 0 }}>Gestion des professeurs</h1>
          <p style={{ fontSize: 16, color: "#64748b", marginTop: 4 }}>{professeurs.length} professeurs enregistrés</p>
        </div>
              ...
              <tr key={p.id} style={{ borderBottom: "1px solid #f1f5f9", background: i % 2 === 0 ? "#fff" : "#fafafa" }}>
                <td style={{ padding: "12px 16px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <span style={{ fontSize: 16, fontWeight: 500 }}>{p.nom}</span>
                  </div>
                </td>
                <td style={{ padding: "12px 16px", fontSize: 16, color: "#334155" }}>{p.matiere}</td>
                <td style={{ padding: "12px 16px", fontSize: 16, color: "#334155" }}>{p.telephone}</td>
                <td style={{ padding: "12px 16px", fontSize: 16, color: "#334155" }}>{p.email}</td>
                <td style={{ padding: "12px 16px" }}>
                  <span style={{
        ...
        <div style={{
          ...
          <div style={{ background: "#fff", borderRadius: 14, padding: 28, width: 420, boxShadow: "0 20px 60px rgba(0,0,0,0.15)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              <h2 style={{ fontSize: 20, fontWeight: 700, margin: 0 }}>Ajouter un professeur</h2>
              <button onClick={() => setShowModal(false)} style={{ background: "none", border: "none", cursor: "pointer", color: "#94a3b8", fontSize: 23 }}>
                <i className="ti ti-x" />
              </button>
            </div>
            {[
