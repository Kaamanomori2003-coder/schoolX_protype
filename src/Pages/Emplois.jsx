  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", color: "#0f172a" }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 25, fontWeight: 700, margin: 0 }}>Gestion des emplois du temps</h1>
        <p style={{ fontSize: 16, color: "#64748b", marginTop: 4 }}>Classe : Terminale A — Semaine type</p>
      </div>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ background: "#f8fafc", borderBottom: "1px solid #e2e8f0" }}>
              <th style={{ padding: "12px 16px", textAlign: "left", fontSize: 15, fontWeight: 600, color: "#64748b", textTransform: "uppercase", letterSpacing: "0.5px", width: 80 }}>Heure</th>
              {Object.keys(emploisData).map(jour => (
                <th key={jour} style={{ padding: "12px 16px", textAlign: "center", fontSize: 15, fontWeight: 600, color: "#64748b", textTransform: "uppercase", letterSpacing: "0.5px" }}>{jour}</th>
              ))}
            </tr>
          </thead>
          <tbody>
            {heures.map((heure, i) => (
              <tr key={heure} style={{ borderBottom: "1px solid #f1f5f9", background: i % 2 === 0 ? "#fff" : "#fafafa" }}>
                <td style={{ padding: "12px 16px", fontSize: 15, fontWeight: 600, color: "#64748b" }}>{heure}</td>
                  ...
                  return (
                    <td key={j} style={{ padding: "10px 12px", textAlign: "center" }}>
                      {matiere ? (
                        ...
                        <span style={{ color: "#e2e8f0", fontSize: 21 }}>—</span>
                      )}
                    </td>
                  );
                })}
